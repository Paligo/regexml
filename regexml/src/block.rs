...
// Do not edit this file directly (except to autoformat)
...
pub(crate) const GREEK: Block = Block {
    name: "Greek",
    start: 0x370,
    end: 0x3FF,
};

pub(crate) const COMBININGMARKSFORSYMBOLS: Block = Block {
    name: "CombiningMarksforSymbols",
    start: 0x20D0,
    end: 0x20FF,
};
